...
export const translations = {
  FR: {
    ...
    voices_subtitle: "Des voix de la wilaya — en arabe, en français, en tamazight.",
  ...
  AR: {
    ...
    voices_subtitle: "أصوات من الولاية — بالعربية، الفرنسية، والتمازيغت.",
  ...
  TZM: {
    ...
    voices_subtitle: "Isellassen n tmurt — s taɛrabt, tafransist, tamaziɣt.",
